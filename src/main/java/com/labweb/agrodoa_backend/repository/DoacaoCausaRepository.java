...
public interface DoacaoCausaRepository extends JpaRepository<DoacaoCausa, IdDoacaoCausa>{
    ...
    ArrayList<Long> findAllByUsuario(@Param("idConta") Long idConta);  //causas em que um usuario ta investindo
    ...
    ArrayList<Long> findAllByCausa(@Param("idCausa") Long idCausa);  //usuarios contribuindo para uma causa
} 