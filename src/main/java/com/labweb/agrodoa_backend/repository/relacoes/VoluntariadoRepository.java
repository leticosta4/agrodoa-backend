...
public interface VoluntariadoRepository extends JpaRepository<Voluntariado, IdVoluntariado>{
    ...
    ArrayList<String> findAllByUsuario(@Param("idConta") String idConta);  //causas em que um usuario ta se voluntariando
    ...
    ArrayList<String> findAllByCausa(@Param("idCausa") String idCausa);  //usuarios voluntarios em uma causa
} 